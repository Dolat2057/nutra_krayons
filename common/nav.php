...
margin-top:-26px;
    ...
    @media only screen and (min-width:767px) and (max-width:827px) {
      .pr-5 {
 ...
 <a href="<?= URL?>index.php" class="navbar-brand"><img src="<?= URL ?>assests/images/logo1.png" style="height:52px;width:100px" alt=""></a>
    ...
    <div class="social h4 social1">
      ...
      <?php } else { ?>
        ...
        <a href="<?= URL ?>user/login.php" style="font-size:1rem !important" class="login-slash">Login</a><span style="color: #73AE20;" class="slash">/<a href="<?= URL ?>user/registration.php" class="reg-slash" style="font-size:1rem !important">Register</a></span>
      ...
      <a href="#" onclick="openNav()" style="color:#000"><i class="fa fa-shopping-cart" style="color:#000;"><?php echo $count; ?></i></a>
    </div>
        ...
        <tbody>
          ...
          if (isset($_SESSION['cart'])) {
            ...
            foreach ($_SESSION['cart'] as $key => $value) {
              // hide the quantity in the td tag
              echo "
                                    <tr>
